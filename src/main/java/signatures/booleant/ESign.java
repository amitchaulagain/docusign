...
//        PrivateKey myPrivateKey = pkEntry.getPrivateKey();
        ...
        ks.setKeyEntry("hero", keyPair.getPrivate(), "hero".toCharArray(), certificateChain2);
        ...
        try {
            fos = new java.io.FileOutputStream("aadat.jceks");
            ks.store(fos, password);
        } finally {
            if (fos != null) {
                fos.close();
        ...
        KeyStore.Entry ll = ks.getEntry("hero", new KeyStore.PasswordProtection("hero".toCharArray()));
