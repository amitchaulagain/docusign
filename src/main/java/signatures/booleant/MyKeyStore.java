...
//        PrivateKey myPrivateKey = pkEntry.getPrivateKey();
        ...
        try {
            fos = new java.io.FileOutputStream("heroine.jceks");
            ks.store(fos, password);
        } finally {
            if (fos != null) {
                fos.close();
        ...
        KeyStore.ProtectionParameter protParam = new KeyStore.PasswordProtection("11".toCharArray());

        KeyStore.Entry entry=ks.getEntry("lala",protParam);
